...
# The rider simply enters a name into a program to reserve a place. Riders that purchase a VIP pass get to skip
# past the common riders up to the last VIP rider in line. VIPs board the ride first.
# (Considering the average wait time for a Disneyland ride is about 45 minutes, this might be a useful program.)
# For this system, an employee manually selects when the ride is dispatched (thus removing the next riders from
