...
##### DON'T REMOVE THIS LOOP!!! SAVE FOR FUTURE REFERENCE #########
# Loop through dict to format output as required by the assignment instructions
# Doesn't work!! Forgot dict() doesn't keep order. Output is always randomized
# for service in servicePrices:
#     print('%s -- $%d' % (service, servicePrices[service]))
